...
For example, if your last name is 'Walker' and you live in a neighborhood that is around 80% White, the BISG algorithm will place a high probability that you are White. Similarly, if your surname is Martinez and you live in a Hispanic dominated census tract, the imputation will guess that you are more likely to be Hispanic. Please refer to [our technical article] for a primer on implementing BISG during data analysis.
